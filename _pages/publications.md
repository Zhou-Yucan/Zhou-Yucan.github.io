...
Published in The ACM Web Conference (**WWW**), **CCF-A**, 2026

Zenghao Guan, Guojun Zhu, **Yucan Zhou**, Wu Liu, Weiping Wang, Jiebo Luo, Xiaoyan Gu

## 23. Statistics Caching Test-Time Adaptation for Vision-Language Models

Published in Advances in Neural Information Processing Systems (**NeurIPS**), **CCF-A**, 2025

Zenghao Guan, **Yucan Zhou**, Wu Liu, Xiaoyan Gu

## 22. Diversity-Enhanced Distribution Alignment for Dataset Distillation
...
Ziwei Li, Feifei Dai, **Yucan Zhou**, Haihui Fan, Xiaoyan Gu, Dan Meng

## 16. Diversified Semantic Distribution Matching for Dataset Distillation
...
Published in International Joint Conference on Artificial Intelligence (**IJCAI**), **CCF-A**, 2021

Shu Zhao, Dayan Wu, **Yucan Zhou**, Bo Li, Weiping Wang

## 6. Multi-Feature Graph Attention Network for Cross-Modal Video-Text Retrieval
...
Published in IEEE/CVF Conference on Computer Vision and Pattern Recognition (**CVPR**), **CCF-A**, 2020

Zhi Qiao, Yu Zhou, Dongbao Yang, **Yucan Zhou**, Weiping Wang

## 1. Local Bayes Risk Minimization Based Stopping Strategy for Hierarchical Classification

Published in IEEE International Conference on Data Mining (**ICDM**), 2017

Yu Wang, Qinghua Hu, **Yucan Zhou**, Hong Zhao, Yuhua Qian, Jiye Liang

---

# Journal Publications

## 12. Decoupling and Alleviating Knowledge Bias for Federated Learning under Data Heterogeneity
...
## 10. Adaptive Diversity Induced Reweighting for Long-Tailed Classification
...
## 5. Robust Hierarchical Feature Selection Driven by Data and Knowledge
...
## 3. Kernel-Based Semantic Hashing for Gait Retrieval

Published in **IEEE Transactions on Circuits and Systems for Video Technology (TCSVT)**, 2018

**Yucan Zhou**, Yongzhen Huang, Qinghua Hu, Liang Wang

## 2. Large-Scale Multimodality Attribute Reduction With Multi-Kernel Fuzzy Rough Sets

Published in **IEEE Transactions on Fuzzy Systems (TFS)**, 2018

Qinghua Hu, Lingjun Zhang, **Yucan Zhou**, Witold Pedrycz

## 1. Combining Heterogeneous Deep Neural Networks with Conditional Random Fields for Chinese Dialogue Act Recognition
